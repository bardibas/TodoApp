package Priti.com.project.todo_application;
...
public class AddEditTodoActivity extends AppCompatActivity {
    public static final String EXTRA_Id="np.com.cbikas.todo.EXTRA_Id";
    public static final String EXTRA_TITLE="np.com.cbikas.todo.EXTRA_TITLE";
    public static final String EXTRA_DESCRIPTION="np.com.cbikas.todo.EXTRA_DESCRIPTION";
    public static final String EXTRA_PRIORITY="np.com.cbikas.todo.EXTRA_PRIORITY";

...
import Priti.com.project.todo_application.mvvm_model.Todo;
import Priti.com.project.todo_application.mvvm_model.TodoModel;

public class MainActivity extends AppCompatActivity {

    private TodoModel noteViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteViewModel = ViewModelProviders.of(this).get(TodoModel.class);
